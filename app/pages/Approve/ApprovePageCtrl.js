(function () {
    ...
    angular.module('BlurAdmin.pages.Approve')
        .controller('ApprovePageCtrl', ApprovePageCtrl);

    /** @ngInject */
    function ApprovePageCtrl($scope, $uibModal, $timeout, toastr, $http) {
        fetch_data();
        ...
        $scope.showModal = function (item) {
            $uibModal.open({
                ...
                templateUrl: 'app/pages/Approve/dangermodal.html'
        ...
        $scope.approve_fund = function (item) {
            ...
            db.collection("Registered_Startup").doc(item.cin).update({"sanction":"200"});
//            db.collection("fundapproval").doc()
        }
